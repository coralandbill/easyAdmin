...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${adminUser.name}</strong></span>
                                <span class="text-muted text-xs block">${adminUser.roleName}<b class="caret"></b></span>
                                </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li class="divider"></li>--%>
                            <li><a href="/admin/loginOut.do">安全退出</a>
                            </li>
                        </ul>
                    </div>
                ...
                <c:forEach items="${menuList}" var="menu" varStatus="st">
                    <%@include file="./include/treeMenu.jsp"%>
                </c:forEach>
            </ul>
        </div>
    </nav>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="/admin/loginOut.do" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
