...
public interface OrgAccountInfoMapper {
    ...
    @Insert({
        ...
        "#{companyId,jdbcType=INTEGER}, #{nickName,jdbcType=VARCHAR}, ",
        "#{logoUrl,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP})"
    })
    ...
    @Select({
        "select",
        "id, userName, openId, companyId, nickName, logoUrl, createTime",
        "from orgaccountinfo",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
