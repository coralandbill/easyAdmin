...
public interface AdminUserMapper {
    ...
    @Insert({
        ...
        "email, street, creator, ",
        "flag, last_login_time, ",
        "update_user, update_time)",
        "values (#{name,jdbcType=VARCHAR}, #{psw,jdbcType=VARCHAR}, ",
        "#{email,jdbcType=VARCHAR}, #{street,jdbcType=VARCHAR}, #{creator,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, name, psw, email, street, creator, flag, last_login_time, update_user, update_time",
        "from admin_user",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
