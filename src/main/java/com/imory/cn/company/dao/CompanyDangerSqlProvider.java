...
public class CompanyDangerSqlProvider {
    ...
    public String insertSelective(CompanyDanger record) {
        ...
        if (record.getWf_ta() != null) {
            VALUES("wf_ta", "#{wf_ta,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalNum() != null) {
            VALUES("totalNum", "#{totalNum,jdbcType=VARCHAR}");
        }
        ...
        if (record.getOneRecordId() != null) {
            VALUES("oneRecordId", "#{oneRecordId,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getWf_ta() != null) {
            SET("wf_ta = #{record.wf_ta,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalNum() != null) {
            SET("totalNum = #{record.totalNum,jdbcType=VARCHAR}");
        }
        ...
        if (record.getOneRecordId() != null) {
            SET("oneRecordId = #{record.oneRecordId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(CompanyDanger record) {
        ...
        if (record.getWf_ta() != null) {
            SET("wf_ta = #{wf_ta,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalNum() != null) {
            SET("totalNum = #{totalNum,jdbcType=VARCHAR}");
        }
        ...
        if (record.getOneRecordId() != null) {
            SET("oneRecordId = #{oneRecordId,jdbcType=INTEGER}");
        }
