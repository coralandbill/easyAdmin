...
public interface CompanyDangerMapper {
    ...
    @Insert({
        ...
        "#{orderNum,jdbcType=INTEGER}, #{wf_ta,jdbcType=VARCHAR}, ",
        "#{direction,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{creator,jdbcType=INTEGER}, #{oneRecordId,jdbcType=INTEGER})"
    })
    ...
    @Select({
        "select",
        "id, fileId, name, wf_type, wf_code, orderNum, wf_ta, direction, createTime, ",
        "creator, oneRecordId",
        "from company_danger",
        "where id = #{id,jdbcType=INTEGER}"
    })
