...
public interface CompanyDangerMapper {
    ...
    @Insert({
        ...
        "#{wf_code,jdbcType=VARCHAR}, #{orderNum,jdbcType=INTEGER}, ",
        "#{wf_ta,jdbcType=DOUBLE}, #{direction,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, name, wf_type, wf_code, orderNum, wf_ta, direction, createTime, creator, ",
        "oneRecordId",
        "from company_danger",
        "where id = #{id,jdbcType=INTEGER}"
    })
