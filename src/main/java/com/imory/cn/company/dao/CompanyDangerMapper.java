...
public interface CompanyDangerMapper {
     ...
     */
    @Insert({
        "insert into company_danger (fileId, name, ",
        "wf_type, wf_code, ",
        "wf_ta, totalNum, ",
        "direction, createTime, ",
        "orderNum, creator, ",
        "oneRecordId)",
        "values (#{fileId,jdbcType=INTEGER}, #{name,jdbcType=VARCHAR}, ",
        "#{wf_type,jdbcType=VARCHAR}, #{wf_code,jdbcType=VARCHAR}, ",
        "#{wf_ta,jdbcType=VARCHAR}, #{totalNum,jdbcType=VARCHAR}, ",
        "#{direction,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{orderNum,jdbcType=INTEGER}, #{creator,jdbcType=INTEGER}, ",
        "#{oneRecordId,jdbcType=INTEGER})"
    })
    ...
    @Results({
        ...
        @Result(column="wf_ta", property="wf_ta", jdbcType=JdbcType.VARCHAR),
        @Result(column="totalNum", property="totalNum", jdbcType=JdbcType.VARCHAR),
        ...
        @Result(column="oneRecordId", property="oneRecordId", jdbcType=JdbcType.INTEGER)
    })
    ...
    @Select({
        "select",
        "id, fileId, name, wf_type, wf_code, wf_ta, totalNum, direction, createTime, ",
        "orderNum, creator, oneRecordId",
        "from company_danger",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
    ...
    @Update({
        ...
        "set fileId = #{fileId,jdbcType=INTEGER},",
          ...
          "wf_ta = #{wf_ta,jdbcType=VARCHAR},",
          "totalNum = #{totalNum,jdbcType=VARCHAR},",
          "direction = #{direction,jdbcType=VARCHAR},",
          "createTime = #{createTime,jdbcType=TIMESTAMP},",
          "orderNum = #{orderNum,jdbcType=INTEGER},",
          "creator = #{creator,jdbcType=INTEGER},",
          "oneRecordId = #{oneRecordId,jdbcType=INTEGER}",
        "where id = #{id,jdbcType=INTEGER}"
    })
