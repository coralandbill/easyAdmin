...
public interface UserInformMapper {
     ...
     */
    @Insert({
        "insert into user_inform (creator, title, ",
        "openId, nickName, ",
        "logoUrl, content, ",
        "state, replayContent, ",
        "replayDate, createTime, ",
        "imgUrl)",
        "values (#{creator,jdbcType=INTEGER}, #{title,jdbcType=VARCHAR}, ",
        "#{openId,jdbcType=VARCHAR}, #{nickName,jdbcType=VARCHAR}, ",
        "#{logoUrl,jdbcType=VARCHAR}, #{content,jdbcType=VARCHAR}, ",
        "#{state,jdbcType=INTEGER}, #{replayContent,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, creator, title, openId, nickName, logoUrl, content, state, replayContent, ",
        "replayDate, createTime, imgUrl",
        "from user_inform",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
